        ...
        <div class="row g-2 align-items-end">
          ...
          <div class="col-md-2">
            <div class="input-group">
              <input class="form-control" type="file" ref="taskAddPictureRef" 
                     @change="taskAddPictureChange" accept="image/*">
              <button v-if="taskAddImageUrl" type="button" 
          ...
          <div class="col-auto">
            <div v-if="taskAddImageUrl" class="position-relative">
              <img :src="taskAddImageUrl" style="max-height: 60px;" 
          ...
          <div class="col-md-12 mt-2">
            <div class="form-floating">
              <textarea class="form-control" v-model="taskToAdd.description" 
            ...
            <div class="row g-3">
              ...
              <div class="col-12" v-if="taskToEdit.picture && !removeImageFlag">
                <div class="text-center mb-3">
                  ...
                  <div class="position-relative d-inline-block">
                    <img :src="taskToEdit.picture" style="max-height: 100px;" 
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input class="form-control" type="file" ref="taskEditPictureRef" 
                           @change="taskEditPictureChange" accept="image/*">
                    <button v-if="taskEditImageUrl" type="button" 
                ...
                <div class="text-center mb-3" v-if="taskEditImageUrl && taskEditPictureRef?.files?.length">
                  ...
                  <div class="position-relative d-inline-block">
                    <img :src="taskEditImageUrl" style="max-height: 100px;" 
